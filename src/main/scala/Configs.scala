...
class TestConfig06 extends Config(
  new constellation.channel.WithUniformVirtualChannels(4, UserVirtualChannelParams(5)) ++
  new constellation.topology.UnidirectionalLineConfig(2, Seq(0), Seq(1)))
...
class TestConfig20 extends Config(
  new constellation.channel.WithUniformVirtualChannels(1, UserVirtualChannelParams(5)) ++
...
class TLTestConfig00 extends Config(
  ...
  new constellation.channel.WithUniformVirtualChannels(5, UserVirtualChannelParams(1)) ++
...
class TLTestConfig01 extends Config(
  ...
  new constellation.channel.WithUniformVirtualChannels(7, UserVirtualChannelParams(3)) ++
