...
class TestConfig00 extends Config(
  ...
  new constellation.channel.WithFullyConnectedIngresses(Seq(0)) ++
...
class TestConfig02 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(3, UserVirtualChannelParams(3)) ++
  new constellation.channel.WithFullyConnectedIngresses(Seq(0, 0)) ++
  new constellation.channel.WithEgresses(Seq(1, 1)) ++
  new constellation.topology.WithUnidirectionalLineTopology(2))
...
class TestConfig05 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(3, UserVirtualChannelParams(3)) ++
  new constellation.channel.WithFullyConnectedIngresses(Seq(0, 1, 1)) ++
...
class TestConfig07 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(3, UserVirtualChannelParams(3)) ++
  new constellation.channel.WithFullyConnectedIngresses(0 until 2) ++
...
class TestConfig09 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(3, UserVirtualChannelParams(3)) ++
  new constellation.channel.WithFullyConnectedIngresses(1 until 3) ++
...
class TestConfig10 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(3, UserVirtualChannelParams(3)) ++
  new constellation.channel.WithFullyConnectedIngresses(Seq(1, 1, 2, 2)) ++
...
class TestConfig12 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(4, UserVirtualChannelParams(5)) ++
  new constellation.channel.WithFullyConnectedIngresses(Seq(0, 2)) ++
...
class TestConfig13 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(4, UserVirtualChannelParams(5)) ++
  new constellation.channel.WithFullyConnectedIngresses(0 until 10 by 2) ++
...
class TestConfig14 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(4, UserVirtualChannelParams(5)) ++
  new constellation.channel.WithFullyConnectedIngresses(0 until 10) ++
...
class TestConfig16 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(4, UserVirtualChannelParams(5)) ++
  new constellation.channel.WithFullyConnectedIngresses(0 until 4 by 2) ++
...
class TestConfig19 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(4, UserVirtualChannelParams(5)) ++
  new constellation.channel.WithFullyConnectedIngresses((0 until 10) ++ (0 until 10)) ++
...
class TestConfig20 extends Config(
  ...
  new constellation.channel.WithFullyConnectedIngresses((0 until 2) ++ (0 until 2)) ++
...
class TestConfig21 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(1, UserVirtualChannelParams(5)) ++
  new constellation.channel.WithFullyConnectedIngresses((0 until 4) ++ (0 until 4)) ++
...
class TestConfig22 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(1, UserVirtualChannelParams(5)) ++
  new constellation.channel.WithFullyConnectedIngresses((0 until 8) ++ (0 until 8)) ++
...
class TestConfig23 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(1, UserVirtualChannelParams(5)) ++
  new constellation.channel.WithFullyConnectedIngresses((0 until 3) ++ (0 until 3)) ++
...
class TestConfig24 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(1, UserVirtualChannelParams(5)) ++
  new constellation.channel.WithFullyConnectedIngresses((0 until 9) ++ (0 until 9)) ++
...
class TestConfig25 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(4, UserVirtualChannelParams(5)) ++
  new constellation.channel.WithFullyConnectedIngresses(0 until 9) ++
...
class TestConfig26 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(4, UserVirtualChannelParams(5)) ++
  new constellation.channel.WithFullyConnectedIngresses(0 until 18) ++
...
class TestConfig27 extends Config(
  new constellation.channel.WithUniformNVirtualChannels(4, UserVirtualChannelParams(5)) ++
  new constellation.channel.WithFullyConnectedIngresses(0 until 25) ++
